...
<nav class="navbar navbar-light">
    <a class="navbar-brand text-info font-weight-bold" ><h3>event LIST</h3></a>
            ...
            <table class="content-table table" id="table-id">
                ...
                <tbody>
                	 <c:forEach var="allevent" items="${eventlist}" >
			            ...
			            <td>${allevent.event_desc}</td>
			           <td ><img src="data:image/jpeg;base64,${allevent.event_img}" width="100" height="100"/></td>
                        <td class="d-flex">
